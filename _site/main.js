  ...
  if (append) {
    append.innerHTML = "";
		obj.forEach(function (current) {
			$(append)
				.append("<div class='cart__item'> <img src=" + current.image + " /> <div class='cart__meta'> <h2> " + current.description + " </h2> <p> quantity: " + current.quantity + " </p> <p> price: " + current.price + " </p> </div> <p class='exit'> x </p> </div>");

			$(".exit").data("item-id", current.id);

			$(".exit").click(function () {
				console.log($(this).data("item-id"), this)
